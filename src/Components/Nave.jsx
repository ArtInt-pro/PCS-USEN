    ...
    <header className='header' data-header>
      ...
      >
        ...
        <nav
          className={
            !nav2
              ? 'md:navbar lg:hidden fixed left-0 top-0 h-screen w-[60%] p-5 items-center  border-[1px] bg-[#f5fffc] ease-in-out duration-1000 drop-shadow-2xl'
              : 'fixed left-[-100%] navbar'
          }
        >
          ...
          <ul className='navbar-list z-50 '>
            <AiFillCloseCircle
              size={27}
              color=''
              onClick={handleNav2}
              className='ml-72 lg:hidden'
            />
            <li>
              <Link to={'/'} className='navbar-link' style={{ fontWeight: 'bolder', fontSize: 20 }}>
                Home
              </Link>
            </li>
            <li>
        ...
        <button className='btn-outline' style={{ zIndex: 100 }} onClick={handleNav}>
          Sign In
        </button>
      ...
      <div
        className={
          !nav
            ? 'fixed right-0 top-0 w-[40%] h-[100%] p-5 border-green-500 border-[1px] bg-white ease-in-out duration-1000 drop-shadow-2xl'
            : 'hidden md:flex fixed right-[-1000%]'
        }
      >
        {/* <div>
